...
import 'package:kff_super_admin/app/screens/arena_management/pages/arena_photo_uploader.dart';
import 'package:kff_super_admin/app/screens/arena_management/pages/arena_price_accordation.dart';
...
class _ArenaEditPageState extends State<ArenaEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<ArenaManagementBloc, ArenaManagementState>(
        listener: (context, state) {
          if (state is ArenaManagementSuccess) {
          ...
          } else if (state is ArenaManagementError) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(state.message),
